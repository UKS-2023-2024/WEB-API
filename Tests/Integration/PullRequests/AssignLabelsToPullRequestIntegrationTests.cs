...
public class AssignLabelsToPullRequestIntegrationTests : BaseIntegrationTest
{
    public AssignLabelsToPullRequestIntegrationTests(TestDatabaseFactory factory) : base(factory)
    {
    }

    [Fact]
    async Task AssignLabelsToPullRequest_ShouldBeSuccessful_WhenCommandIsValid()
    {
        //Arrange
        var command = new AssignLabelsToPullRequestCommand(new Guid("8e9b1cc3-36d3-4bf2-9f4c-9e00a21d94b3"), new Guid("7e9b1cc0-35d3-4bf2-9f2c-5e00a21d92a5")
    ...
    [Fact]
    async Task AssignLabelsToPullRequest_ShouldFail_WhenPullRequestNotFound()
    {
        //Arrange
    ...
    [Fact]
    async Task AssignLabelsToPullRequest_ShouldFail_WhenUserNotRepositoryMember()
    {
        //Arrange
