...
public class FindAllUsersThatStarredIntegrationTest :BaseIntegrationTest
{
    public FindAllUsersThatStarredIntegrationTest(TestDatabaseFactory factory) : base(factory)
    {
    }
    ...
    {
        //Arrange
        var command = new FindAllUsersThatStarredQuery(new Guid("7e9b1cc0-35d3-4bf2-9f2c-5e00a21d92a9"),
    ...
    {
        //Arrange
        var command = new FindAllUsersThatStarredQuery(new Guid("7e9b1cc0-35d3-4bf2-9f2c-5e00a21d92a7"),
            new Guid("8e9b1cc3-35d3-4bf2-9f2c-9e00a21d94a5"));
