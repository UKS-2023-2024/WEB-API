...
public class RemoveRepositoryMemberUnitTests
{
    ...
    public RemoveRepositoryMemberUnitTests()
    {
        ...
        var repoMember2 = RepositoryMember.Create(_user4, _repository1, RepositoryMemberRole.ADMIN);
        OverrideId(repoMember2, new Guid("8e9b1111-ffbb-4bf2-9f2c-5e00a21d92a9"));
        ...
        _repositoryMemberRepositoryMock.Setup(x => x.FindByUserIdAndRepositoryId(_user4.Id,_repository1.Id)).ReturnsAsync(repoMember2);
        ...
        _repositoryMemberRepositoryMock.Setup(x => x.FindByUserIdAndRepositoryId(_user1.Id,_repository2.Id)).ReturnsAsync(repoMember5);
        _repositoryMemberRepositoryMock.Setup(x => x.Find(_repoMember1.Id)).Returns(_repoMember1);
        _repositoryMemberRepositoryMock.Setup(x => x.Find(repoMember2.Id)).Returns(repoMember2);
        ...
        _repositoryMemberRepositoryMock.Setup(x => x.Find(repoMember5.Id)).Returns(repoMember5);
        ...
        _repositoryMemberRepositoryMock.Setup(x => x.FindNumberRepositoryMembersThatAreOwnersExceptSingleMember(_repository1.Id,repoMember2.Id)).Returns(1);
    ...
    public void Handle_ShouldReturnSuccess_WhenUserMemberAndOwnerHasPrivileges()
    {
        ...
        //Act
        var result = new RemoveRepositoryMemberCommandHandler(_repositoryRepository.Object,
                _repositoryMemberRepositoryMock.Object, _gitServiceMock.Object)
    ...
    {
        //Arrange
        var command = new RemoveRepositoryMemberCommand(_user4.Id,
            _repoMember1.Id, _repository1.Id);
        var handler = new RemoveRepositoryMemberCommandHandler(_repositoryRepository.Object,
            _repositoryMemberRepositoryMock.Object,_gitServiceMock.Object);
