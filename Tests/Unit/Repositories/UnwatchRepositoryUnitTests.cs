...
public class UnwatchRepositoryUnitTests
{
    ...
    public UnwatchRepositoryUnitTests()
    {
        ...
        RepositoryWatcher repositoryWatcher = RepositoryWatcher.Create(_user.Id, WatchingPreferences.AllActivity, repository4.Id);
        ...
        _repositoryWatcherRepositoryMock.Setup(x => x.FindByUserIdAndRepositoryId(_user.Id, repository4.Id)).ReturnsAsync(repositoryWatcher);
    }
    ...
    public void Handle_ShouldReturnSuccess_WhenUserWatchedRepositoryBefore()
    {
        ...
        //Act
        var result = new UnwatchRepositoryCommandHandler(_repositoryRepositoryMock.Object, _repositoryWatcherRepositoryMock.Object).Handle(command, default);
    ...
    public async void Unwatch_ShouldReturnError_WhenUserDidntStarRepository()
    {
        ...
        var handler = new UnwatchRepositoryCommandHandler(_repositoryRepositoryMock.Object, _repositoryWatcherRepositoryMock.Object);
