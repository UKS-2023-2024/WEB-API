...
public class UpdateBranchNameUnitTests
{
    ...
    public async void UpdateBranchName_ShouldFail_WhenBranchWithSameNameExistsInRepository()
    {
        //Arrange
        var command = new UpdateBranchNameCommand(new Guid("705a6c69-5b51-4156-b4cc-71e8dd111579"), "changedName");
        Branch branch1 = Branch.Create(new Guid("705a6c69-5b51-4156-b4cc-71e8dd111572"), "name", new Guid("705a6c69-5b51-4156-b4cc-71e8dd111570"), false, new Guid("805a6c69-5b51-4156-b4cc-71e8dd111571"));
        Branch branch2 = Branch.Create(new Guid("705a6c69-5b51-4156-b4cc-71e8dd111573"), "changedName", new Guid("705a6c69-5b51-4156-b4cc-71e8dd111570"), false, new Guid("805a6c69-5b51-4156-b4cc-71e8dd111571"));
