...
public class AssignUsersToPullRequestsUnitTests
{
    ...
    [Fact]
    public async void AssignUsersToPullRequest_ShouldBeSuccessful_WhenCommandIsValid()
    {
        //Assert
        var command = new AssignUsersToPullRequestCommand(It.IsAny<Guid>(), It.IsAny<Guid>(), new List<Guid>() { new Guid("8e9b1cc0-35d3-4bf2-9f2c-5e00a21d94a5")}); 
        ...
        PullRequest pr = PullRequest.Create("pr", "pr", 1, repository, user.Id, new List<RepositoryMember>() { member }, It.IsAny<List<Label>>(), null, It.IsAny<Guid>(), It.IsAny<Guid>(), new List<Issue>() { issue });
    ...
    [Fact]
    public async void AssignUsersToPullRequest_ShouldFail_WhenPulLRequestNotFound()
    {
        //Assert
        var command = new AssignUsersToPullRequestCommand(It.IsAny<Guid>(), It.IsAny<Guid>(), new List<Guid>() { new Guid("8e9b1cc0-35d3-4bf2-9f2c-5e00a21d94a5") });
        User user = User.Create(It.IsAny<Guid>(), "anav@gmail.com", "test test", "test", "$2a$12$.33VvcDZ.ahQ0wEg3RMncurrbdUU0lkhyLQU2d1vVPXZlQSvgB5qq", UserRole.ADMINISTRATOR);
    ...
    [Fact]
    public async void AssignUsersToPullRequest_ShouldFail_WhenUserNotRepositoryMember()
    {
        //Assert
        var command = new AssignUsersToPullRequestCommand(It.IsAny<Guid>(), It.IsAny<Guid>(), new List<Guid>() { new Guid("8e9b1cc0-35d3-4bf2-9f2c-5e00a21d94a5") });
        User user = User.Create(It.IsAny<Guid>(), "anav@gmail.com", "test test", "test", "$2a$12$.33VvcDZ.ahQ0wEg3RMncurrbdUU0lkhyLQU2d1vVPXZlQSvgB5qq", UserRole.ADMINISTRATOR);
