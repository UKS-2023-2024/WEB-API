...
public class FindIssueEventsQueryHandler: IQueryHandler<FindIssueEventsQuery, List<Event>>
{
    ...
    public FindIssueEventsQueryHandler(IIssueRepository issueRepository, IMilestoneRepository milestoneRepository, IRepositoryMemberRepository repositoryMemberRepository)
    {
